...
/*
        ...
        <script src="lib/havok/lib/umd/HavokPhysics_umd.js"></script>
*/
...
export default class SceneController {
  ...
  async createEnvironment() {
    const tube = await BABYLON.SceneLoader.ImportMeshAsync(null,
            './models/tube.glb',
        );
    ...
    for (let i = 0; i < 20; i++) {
      const ground = await BABYLON.SceneLoader.ImportMeshAsync(null,
                './models/tower.glb',
            );
