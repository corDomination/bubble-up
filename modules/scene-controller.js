...
// // import { HavokPlugin } from "../node_modules/@babylonjs/core/Physics/v2/Plugins/havokPlugin.js";
// // import {HavokPhysics} from "../node_modules/@babylonjs/havok/lib/esm/HavokPhysics_es.js";


// // // import "../node_modules/@babylonjs/core/Debug/debugLayer"; // Augments the scene with the debug methods
// // // import "../node_modules/@babylonjs/inspector";
// // // // import { GLTF2Export } from '@babylonjs/serializers/glTF';
// // // import HavokPhysics from "../node_modules/@babylonjs/havok";
import SpecialBubbleController from './special-bubble-controller.js';
...
export default class SceneController {
  ...
  async createEnvironment() {
    const tube = await LOADERS.GLTFFileLoader.ImportMeshAsync(null,
      './models/tube.glb',
    );
    ...
    for (let i = 0; i < 20; i++) {
      const ground = await LOADERS.GLTFFileLoader.ImportMeshAsync(null,
        './models/tower.glb',
      );
    ...
    for (let i = 0; i < 20; i++) {
      const specialBubble1 = new SpecialBubbleController(this);
      const x = (Math.random() - 0.5) * 160 * Math.sqrt(i * 2);
    ...
    // const collisions = this.scene.meshes.filter(item =>
